...
import { sendmessage, UpdateLoading } from "@/actions/message.action";
...
const AnimatedPlaceholder = ({
  ...
  <AnimatePresence mode="wait">
    <motion.p
      ...
      className="pointer-events-none w-[150px] text-xl absolute text-black/70 dark:text-white/70">
      {showSearch ? "Chat with AI" : "Search the web..."}
    </motion.p>
  </AnimatePresence>
)
